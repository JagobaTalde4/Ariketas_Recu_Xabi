  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "0f6d827a-2eb4-4d53-9342-5fa5b2463503",
          "type": "basic.info",
          "data": {
            "info": "Ejercicio 2:\n\nEn este ejercicio tenemos dos pulsadores \"SW1\" y \"SW2\".\nEl \"SW1\" es el boton de reset que lo que hace es cuando el contador tiene un numero volverlo al 0 y el \"SW2\" sirve para que cada vez que pulsemos, el contador cuente 1.\nEl tics del pulsador sirve para cuando pulsemos una vez de un impulso y solo mande una señal y hasta que no pulsemos otra vez no mandara ninguna señal mas, asi conseguimos que cuando pulsemos, solo de un valor\nDespues tenemos el contador, que cada vez que le llegue un inpulso marcara un numero y despues tenemos dos led que lo que hacen es contar en binario segun el contador.",
            "readonly": true
          },
          "position": {
            "x": -96,
