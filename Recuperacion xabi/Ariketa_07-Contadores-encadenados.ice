    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejerccio 7:\n\nEn este circuito tenemos dos botones uno de reset llamado \"SW1\" y el boton de marcha llamado \"SW2\".\nAparte de los pulsadores tenemos dos contadores, uno de esos contadores activara los led en binario y el otro contador mandara la señal al display que esto hace q muestre el valor que tiene el contador.",
            "readonly": true
          },
          "position": {
            "x": -168,
