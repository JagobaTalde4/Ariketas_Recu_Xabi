    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ariketa 14:\n\nEn este ejercicio tenemos un temporizador de 50 segundosa y cada vez que pase mandara una señal, de hay pasa al contador que ira contando cada impulso que le llegue hasta 14 y luego tenemos como una memoria que recuerda la secuencia que ha hecho y despues de eso segun la tabla que nos haya dado ira encendiendo las led en un orden.",
            "readonly": false
          },
          "position": {
            "x": 88,
